            ...
            <div class="container-fluid mt-3" style="background-color: white">
                <div class="row">
                    ...
                    <section class="col-lg-7 offset-lg-1 p-5">
                        <h2 class="mb-4">In Process Orders</h2>
                                ...
                                <table class="wishlist">
                                    <thead class="wishlist__head">
                                        <tr class="wishlist__row">
                                            ...
                                            <th class="wishlist__column wishlist__column--price">Order Date</th>
                                        </tr>
                                    </thead>
                                    ...
                                    <tbody class="wishlist__body">
                                        ...
                                        <tr class="wishlist__row">
                                            ...
                                            <td class="wishlist__column wishlist__column--product"><a
                                                    href="{{('productDetails')}}" class="wishlist__product-name">Banana Cup Cake</a>
                                            </td>

                                            <td class="wishlist__column wishlist__column--stock">
                                                <div class="badge badge-success in-stock-div">Shipped</div>
                                            </td>

                                            <td class="wishlist__column wishlist__column--price">328.00</td>
                                            <td class="wishlist__column wishlist__column--price current_date"></td>
                                        ...
                                        <tr class="wishlist__row">
                                            ...
                                            <td class="wishlist__column wishlist__column--product">
                                                <a href="{{('productDetails')}}" class="wishlist__product-name">Caramel Cup Cake</a>
                                            </td>

                                            <td class="wishlist__column wishlist__column--stock">
                                                <div class="badge badge-success">To be shipped</div>
                                            </td>

                                            <td class="wishlist__column wishlist__column--price">4500.00</td>
                                            <td class="wishlist__column wishlist__column--price current_date"></td>
                                        ...
                                        <tr class="wishlist__row">
                                            <td class="wishlist__column wishlist__column--image">
                                                <a href="{{('productDetails')}}"><img src="imgs/Item1.jpg" alt=""></a>
                                            </td>

                                            <td class="wishlist__column wishlist__column--product">
                                                <a href="{{('productDetails')}}" class="wishlist__product-name">Butter Cup Cake</a>
                                            </td>
